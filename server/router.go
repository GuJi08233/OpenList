...
func _fs(g *gin.RouterGroup) {
	...
	g.POST("/chunked/create", middlewares.FsUp, handles.ChunkedUploadCreate)
	g.PUT("/chunked/upload", uploadLimiter, handles.ChunkedUploadChunk)
	g.POST("/chunked/complete", handles.ChunkedUploadComplete)
	g.GET("/chunked/status", handles.ChunkedUploadStatus)
	g.POST("/chunked/abort", handles.ChunkedUploadAbort)
